...
//             'suppliers_id'		  		=> $suppliers_id,
    ...
    public function clear_spec_data() {
    	...
    	if($count > 0) {
    		return $this->showmessage(__('该规格模板下的货品以及产品了订单交易，不可以更改规格模板', 'goods'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_ERROR, array('url' => RC_Uri::url('goodslib/admin/edit_goods_specification', array('goods_id' => $goods_id))));
    	} else {
    		//清除商品关联的模板id为0
